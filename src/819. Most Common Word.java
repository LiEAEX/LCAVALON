Runtime: 13 ms, faster than 47.52% of Java online submissions for Most Common Word.
Memory Usage: 39.9 MB, less than 33.76% of Java online submissions for Most Common Word.

class Solution {
    public String mostCommonWord(String paragraph, String[] banned) {
        String[] words = paragraph.toLowerCase().split("\\W+"); // \\W means matches the nonword characters. It should be double slash.
